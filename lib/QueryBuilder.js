...
var QueryBuilder = {
  ...
  createQuery: function createQuery(partialQuery) {
    ...
    if (identifyingArgName != null) {
      process.env.NODE_ENV !== 'production' ? warning(partialQuery.identifyingArgValue != null, 'QueryBuilder.createQuery(): An argument value may be required for ' + 'query `%s(%s: ???)`.', partialQuery.fieldName, identifyingArgName) : void 0;
