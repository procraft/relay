...
var xhrSimpleDataSerializer = require('fbjs/lib/xhrSimpleDataSerializer');
...
function createDebuggableFromRequest(type, request, graphiqlPrinter) {
  return {
    ...
    logResult: function logResult(error, response) {
      ...
      var requestSize = formatSize(xhrSimpleDataSerializer({
...
var RelayNetworkDebug = {
  init: function init() {
    var environment = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Relay.Store;
