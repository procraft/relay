...
var PendingFetch = function () {
  ...
  PendingFetch.prototype._handleQuerySuccess = function _handleQuerySuccess(result) {
    ...
    this._storeData.getTaskQueue().enqueue(function () {
      ...
      !(response && typeof response === 'object') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayPendingQueryTracker: Expected response to be an object, got ' + '`%s`.', response ? typeof response : response) : invariant(false) : void 0;
