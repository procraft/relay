...
var RelayQueryConfig = function () {
  ...
  function RelayQueryConfig(initialVariables) {
    ...
    !(this.constructor !== RelayQueryConfig) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryConfig: Abstract class cannot be instantiated.') : invariant(false) : void 0;
