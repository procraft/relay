...
var RelayQueryResultObservable = function () {
  ...
  RelayQueryResultObservable.prototype.subscribe = function subscribe(callbacks) {
    ...
    var subscription = {
      dispose: function dispose() {
        !_this._subscriptionCallbacks[subscriptionIndex] ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryResultObservable: Subscriptions may only be disposed once.') : invariant(false) : void 0;
  ...
  RelayQueryResultObservable.prototype._observe = function _observe() {
    ...
    !!this._fragmentResolver ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryResultObservable: Initialized twice.') : invariant(false) : void 0;
  ...
  RelayQueryResultObservable.prototype._resolveData = function _resolveData(fragmentResolver) {
    ...
    !!Array.isArray(data) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryResultObservable: Plural fragments are not supported.') : invariant(false) : void 0;
    this._data = data;
  };
